...
public class ClusterGen {
	...
	private static final double MIN_LINESEGMENT_LENGTH = 50.0; //originally 50
	private static final int m_minTrajectories = 5; //the minimum number of different trajectories a cluster must be made of 
	...
	public boolean performDBSCAN(double eps, int minLns)  {
		...
		//System.out.println(m_componentIdArray);
	...
	boolean  constructLineSegmentCluster() {
		...
		for (int i = 0; i < m_currComponentId; i++) {
			...
			//  a line segment cluster must have trajectories more than the minimum threshold LIKELY WHY IT FAILS AT THE HIGH VALUES NJA
